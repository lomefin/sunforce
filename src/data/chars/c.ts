// =============================================================================
// SunForce — src/data/chars/c.ts
//
// Character C. **A COPY OF CHARACTER A**, by request: all six characters look
// alike and share one sprite sheet for now. Only the ids differ — CharId.C and
// the MoveId.C_* slots, which were reserved in the contract from the start.
//
...
// Retune the numbers in this file and C becomes its own character without a
...
// =============================================================================
// C_5P — "Jab". 5 startup / 3 active / 9 recovery = 17 total.
...
export const CHAR_C: CharDef = {
  ...
  moveOrder: [MoveId.C_5K, MoveId.C_5P],
  moves: [C_5P, C_5K],
  stick: {
    radii: [
      0, 13, 12, 14, 7, 17, 0,
