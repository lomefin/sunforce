// =============================================================================
// SunForce — src/data/chars/d.ts
//
// Character D. **A COPY OF CHARACTER A**, by request: all six characters look
// alike and share one sprite sheet for now. Only the ids differ — CharId.D and
// the MoveId.D_* slots, which were reserved in the contract from the start.
//
...
// Retune the numbers in this file and D becomes its own character without a
...
// =============================================================================
// D_5P — "Jab". 5 startup / 3 active / 9 recovery = 17 total.
...
export const CHAR_D: CharDef = {
  ...
  moveOrder: [MoveId.D_5K, MoveId.D_5P],
  moves: [D_5P, D_5K],
  stick: {
    radii: [
      0, 13, 12, 14, 7, 17, 0,
