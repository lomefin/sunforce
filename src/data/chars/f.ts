// =============================================================================
// SunForce — src/data/chars/f.ts
//
// Character F. **A COPY OF CHARACTER A**, by request: all six characters look
// alike and share one sprite sheet for now. Only the ids differ — CharId.F and
// the MoveId.F_* slots, which were reserved in the contract from the start.
//
...
// Retune the numbers in this file and F becomes its own character without a
...
// =============================================================================
// F_5P — "Jab". 5 startup / 3 active / 9 recovery = 17 total.
...
export const CHAR_F: CharDef = {
  ...
  moveOrder: [MoveId.F_5K, MoveId.F_5P],
  moves: [F_5P, F_5K],
  stick: {
    radii: [
      0, 13, 12, 14, 7, 17, 0,
