// =============================================================================
// SunForce — src/data/chars/b.ts
//
// Character B. **A COPY OF CHARACTER A**, by request: all six characters look
// alike and share one sprite sheet for now. Only the ids differ — CharId.B and
// the MoveId.B_* slots, which were reserved in the contract from the start.
//
...
// Retune the numbers in this file and B becomes its own character without a
...
// =============================================================================
// B_5P — "Jab". 5 startup / 3 active / 9 recovery = 17 total.
...
export const CHAR_B: CharDef = {
  ...
  moveOrder: [MoveId.B_5K, MoveId.B_5P],
  moves: [B_5P, B_5K],
  stick: {
    radii: [
      0, 13, 12, 14, 7, 17, 0,
